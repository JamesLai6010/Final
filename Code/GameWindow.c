...
Game *New_Game()
{
    ...
    game->title = "Final Project 111062371";
    game->display = NULL;
    game->game_init(game);
    return game;
}
...
bool game_update(Game *self)
{
    ...
    if (scene->scene_end)
    {
        ...
        case 5:
            ...
            break;
        case 6:
            create_scene(GameScene_L3);
            break;
        case 7:
            create_scene(GameScene_L4);
            break;
        case 8:
            create_scene(GameScene_L5);
            break;
        case 10:
